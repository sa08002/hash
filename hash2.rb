...
def info
  ...
  puts @param1[:height] > 129 ? "身長 #{@param1[:height]}cm:身長確認OK" : "身長 #{@param1[:height]}cm:身長確認NG"
  puts ""
...
def info2
  ...
  puts @param2[:height] > 129 ? "身長 #{@param2[:height]}cm:身長確認OK" : "身長 #{@param2[:height]}cm:身長確認NG"
  puts ""
...
def info3
  ...
  puts @param3[:height] > 129 ? "身長 #{@param3[:height]}cm:身長確認OK" : "身長 #{@param3[:height]}cm:身長確認NG"
  puts ""
